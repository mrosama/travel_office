        ...
        <div class="portlet light portlet-fit portlet-form ">
            <div class="portlet-title">
                <div class="caption" style="float:right">
                    ...
                    <span class="caption-subject font-green bold uppercase">اضافة سفارة جديدة</span>
                </div>
            </div>
            ...
            <div class="portlet-body">
                ...
                <!-- BEGIN FORM-->
                {{Form::open(array('route' => 'admin.embassies.store', 'method'=>'post' , 'files'=>'true' , 'class'=>'form-horizontal' , "novalidate"=>"novalidate" , "id"=>"form"))}}
                <div class="form-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            {{Form::text('presence' , '' , ['class'=>'form-control' , 'placeholder'=>'حضور شخصى للسفارة' , 'required'])}}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            {{Form::text('site_url' , '' , ['class'=>'form-control' , 'placeholder'=>'الموقع الالكترونى' , 'required' , 'url'])}}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            {{Form::text('email' , '' , ['class'=>'form-control' , 'placeholder'=>'البريد الالكترونى' , 'required' , 'email'])}}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            {{Form::text('mobile' , '' , ['class'=>'form-control' , 'placeholder'=>'الجوال' , 'required' , 'number'])}}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            {{Form::text('phone' , '' , ['class'=>'form-control' , 'placeholder'=>'الهاتف' , 'required' , 'number'])}}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            {{Form::text('office' , '' , ['class'=>'form-control' , 'placeholder'=>'امكانية مكتب يخلص المعاملة' , 'required'])}}
