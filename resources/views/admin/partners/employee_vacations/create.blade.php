        ...
        <div class="portlet light portlet-fit portlet-form ">
            <div class="portlet-title">
                <div class="caption" style="float:right">
                    ...
                    <span class="caption-subject font-green bold uppercase">اضافة طلب اجازة  جديدة</span>
                </div>
            </div>
            ...
            <div class="portlet-body">
                ...
                <!-- BEGIN FORM-->
                {{Form::open(array('route' => 'admin.employee_vacations.store', 'method'=>'post'  , 'class'=>'form-horizontal' , "novalidate"=>"novalidate" , "id"=>"form"))}}
                <div class="form-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-7">
                            {{Form::select('emp_id' , $employees ,  '' , ['class' => 'form-control' , 'id' => 'partner_employee',  "autofocus"=>"autofocus" ,"autocomplete" =>"on" , 'placeholder' => 'اختر اسم الموظف ....'])}}
                            <font color="red">{{$errors->first('emp_id')}}</font><br>
                            <div id="partner_employee_info"></div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-7">
                            {{Form::select('vacation_type_id' , $vacation_types ,  '' , ['class' => 'form-control' , "autofocus"=>"autofocus" ,"autocomplete" =>"on" , 'placeholder' => 'اختر نوع الاجازة ....'])}}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-7">
                            {{Form::text('day_number' , '' , ['class' => 'form-control' , "autofocus"=>"autofocus" ,"autocomplete" =>"on"])}}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-7">
                            {{Form::text('vacation_start' , '' , ['class' => 'form-control form-control-inline date-picker' , "autofocus"=>"autofocus" , 'placeholder' => 'dd/mm/yyyy', 'data-date-format' => 'dd/mm/yyyy' ,"autocomplete" =>"on" , 'id' =>'vacation_start'])}}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-7">
                            {{Form::text('vacation_end' , '' , ['class' => 'form-control form-control-inline date-picker' , "autofocus"=>"autofocus" , 'placeholder' => 'dd/mm/yyyy', 'data-date-format' => 'dd/mm/yyyy' ,"autocomplete" =>"on" , 'id' =>'vacation_end'])}}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-7">
                            {{Form::text('reason' , '' , ['class' => 'form-control' , "autofocus"=>"autofocus" ,"autocomplete" =>"on"])}}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-7">
                            {{Form::select('nature' , ['1' => 'اجازة براتب' , '2' => 'اجازة بدون راتب'] ,'' , ['class' => 'form-control' , "autofocus"=>"autofocus" ,"autocomplete" =>"on" ,  'placeholder' => 'اختر من فضلك....' ])}}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-7">
                            {{Form::text('remaining' , '' , ['class' => 'form-control' , "autofocus"=>"autofocus" ,"autocomplete" =>"on" ])}}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-7">
                            {{Form::text('previous' , '' , ['class' => 'form-control' , "autofocus"=>"autofocus" ,"autocomplete" =>"on" ])}}
