		...
		<div class="portlet light portlet-fit portlet-form ">
			<div class="portlet-title">
				<div class="caption" style="float:right">
					...
					<span class="caption-subject font-green bold uppercase"> تعديل فاتورة</span>
				</div>
			</div>
			...
			<div class="portlet-body">
				...
				<!-- BEGIN FORM-->
				{{Form::open(array('route' => ['admin.bills.update' , $bill->id], 'method'=>'put' , 'files'=>'true' , 'class'=>'form-horizontal' , 'id'=>'form'))}}
				<div class="form-body">
					...
					<div class="portlet-title">
						<div class="caption">
							...
							<span class="caption-subject font-green sbold uppercase">الدفع و التحويل</span>
						</div>
					</div>
							...
							<div class="col-md-8">
								<div class="fileinput fileinput-new" data-provides="fileinput">
									<div class="fileinput-new thumbnail" style="width: 265px; height: 200px;">
										<img src="{{URL::to($bill->bill_photo)}}" alt="" width="265" />
									</div>
								...
								<div class="form-group">
									...
									<div class="col-md-8">
										{{Form::select('partner_id' , $partners , $bill->partner_id , ["class"=>"bs-select form-control" , "data-live-search"=>"true" , "autofocus"=>"autofocus" , "autocomplete" =>"on" , 'placeholder'=>'من فضلك اختر الشريك' , 'required'])}}
								...
								<div class="form-group">
									...
									<div class="col-md-8">
										{{Form::number('required_amount' , $bill->required_amount , ['class'=>'form-control'  , "autofocus"=>"autofocus" ,  'required' , 'number'])}}
								...
								<div class="form-group">
									...
									<div class="col-md-8">
										{{Form::number('paid_amount' , $bill->paid_amount , ['class'=>'form-control' , 'required' , 'number'])}}
								...
								<div class="form-group">
									...
									<div class="col-md-8">
										{{Form::number('remaining_amount' , $bill->remaining_amount , ['class'=>'form-control' , 'readonly' , 'number'])}}
								...
								<div class="form-group">
									...
									<div class="col-md-8">
										{{Form::date('pay_from_date' , $bill->pay_from_date , ["class"=>"form-control" , 'required' , 'date'])}}
									</div>
								...
								<div class="form-group">
									...
									<div class="col-md-8">
										{{Form::date('pay_to_date' , $bill->pay_to_date , ["class"=>"form-control" , 'required' , 'date'])}}
									</div>
								...
								<div class="form-group">
									...
									<div class="col-md-8">
										{{Form::textarea('notes' , $bill->notes  , ['class'=>'form-control' , 'required'])}}
										<font color="red">{{$errors->first('pay_notes')}}</font><br>
									</div>
								</div>
