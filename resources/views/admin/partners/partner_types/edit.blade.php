        ...
        <div class="portlet light portlet-fit portlet-form ">
            <div class="portlet-title">
                <div class="caption" style="float:right">
                    ...
                    <span class="caption-subject font-green bold uppercase">  اضافة نوع جديد </span>
                </div>
            </div>
            ...
            <div class="portlet-body">
                ...
                <!-- BEGIN FORM-->
                {{Form::open(array('route' => ['admin.partner_types.update' , $partner_type->id], 'method'=>'put'  , 'class'=>'form-horizontal' , "novalidate"=>"novalidate" , "id"=>"form"))}}
                <div class="form-body">
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-3"> نوع الشريك
                        </label>
                        <div class="col-md-7">
                            {{Form::text('name' , $partner_type->name , ['class' => 'form-control' , "autofocus"=>"autofocus" ,"autocomplete" =>"on" , 'required'])}}
                        </div>
                    </div>
