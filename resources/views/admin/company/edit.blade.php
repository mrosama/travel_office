        ...
        <div class="portlet light portlet-fit portlet-form ">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-green bold uppercase">  تعديل بيانات مؤسسة / شركة </span>
                </div>
                <a href="{{URL::to('/admin/company')}}" class="btn btn-success btn-sm" style="float: left;">عرض الكل</a>
            </div>
            <div class="portlet-body">
                <!-- BEGIN FORM-->
                {{Form::open(['route' =>['admin.company.update' , $company->id], 'method' => 'PATCH' , 'class' =>'form-horizontal'  , 'files' =>true])}}
                <div class="form-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <div class="input-icon right">
                                <i class="fa"></i>
                                {!!Form::text('name', $company->name ,array('placeholder'=>'اسم المؤسسة / الشركة','class'=>'form-control', "autofoucs" => "autofoucs" , "autocomplete" =>"on" ))!!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <div class="input-icon right">
                                <i class="fa"></i>
                                {!!Form::text('work_type', $company->work_type ,array('placeholder'=>'طبيعة عمل المؤسسة','class'=>'form-control', "autofoucs" => "autofoucs" , "autocomplete" =>"on" ))!!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <div class="input-icon right">
                                <i class="fa"></i>
                                {!!Form::text('work_time', $company->work_time ,array('placeholder'=>'اوقات الدوام','class'=>'form-control', "autofoucs" => "autofoucs" , "autocomplete" =>"on" ))!!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <div class="input-icon right">
                                <i class="fa"></i>
                                {!!Form::text('owner_name', $company->owner_name ,array('class'=>'form-control', "autofoucs" => "autofoucs" , "autocomplete" =>"on" ))!!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <select name='country' class="bs-select form-control"  data-live-search = 'true' id='country' onchange='getCity()'>
                                <option value="{{$company->country}}">{{$company->countryName->name}}</option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <select name='city' class="bs-select form-control"  data-live-search = 'true' id='city' >
                                <option value="{{$company->city}}">{{$company->cityName->name}}</option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-3">
                            {{HTML::image($company->logo , '' , ['width' => '75px'])}}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="input-icon right">
                                <i class="fa"></i>
                                {!!Form::email('email',$company->email ,array('placeholder'=>'البريد الالكتروني','class'=>'form-control',  "autocomplete" =>"on" ))!!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="input-icon right">
                                <i class="fa"></i>
                                {!!Form::text('mobile',$company->mobile ,array('placeholder'=>'الجوال','class'=>'form-control',  "autocomplete" =>"on" ))!!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="input-icon right">
                                <i class="fa"></i>
                                {!!Form::text('phone',$company->phone ,array('placeholder'=>'الهاتف','class'=>'form-control',  "autocomplete" =>"on" ))!!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <div class="input-icon right">
                                <i class="fa"></i>
                                {!!Form::text('commercial_record', $company->commercial_record ,array('placeholder'=>'السجل التجاري','class'=>'form-control',  "autocomplete" =>"on" ))!!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <div class="input-icon right">
                                <i class="fa"></i>
                                {!!Form::text('mailbox', $company->mailbox ,array('placeholder'=>'صندوق البريد','class'=>'form-control',  "autocomplete" =>"on" ))!!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <div class="input-icon right">
                                <i class="fa"></i>
                                {!!Form::text('postal_code', $company->postal_code ,array('placeholder'=>' الرمز البريدي','class'=>'form-control',  "autocomplete" =>"on" ))!!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="input-icon right">
                                <i class="fa"></i>
                                {!!Form::text('fax',$company->fax ,array('placeholder'=>' الفاكس','class'=>'form-control',  "autocomplete" =>"on" ))!!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <div class="input-icon right">
                                <i class="fa"></i>
                                {!!Form::textarea('address', $company->address ,array('placeholder'=>'العنوان','class'=>'form-control',  "autocomplete" =>"on" ))!!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            {!!Form::text('lat', $company->lat ,array('placeholder'=>'lat','class'=>'form-control', "id" => "lat" ))!!}
                            {!! $errors->first('lat','<div class="alert alert-danger">:message</div>')!!}                            

                        </div>
                        <div class="col-md-4">
                            {!!Form::text('lang', $company->lang ,array('placeholder'=>'lang','class'=>'form-control', "id" => "lang" ))!!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <div class="input-icon right">
                                <i class="fa"></i>
                                {!!Form::text('userName', $company->userName ,array('placeholder'=>'اسم المستخدم','class'=>'form-control',  "autocomplete" =>"on" ))!!}
                ...
                <div class="form-actions">
                    <div class="row">
                        <div class="col-md-offset-3 col-md-9">
                            ...
                            <button type="button" class="btn default">{!! link_to_route('admin.company.index', 'عودة')  !!} </button>
