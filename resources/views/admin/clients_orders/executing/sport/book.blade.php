...
<div class="row">
	...
	<div class="col-md-12">
		...
		<div class="" style="height: 120px;">
			...
			<div class="col-md-4" style="background-color:#BCAEA5;text-align:left;height:100px">
				<div class="sepet_baslik"> Booking Info</div>
			</div>
			<div class="col-md-8" style="background-color:#3FBFB8;text-align:left;height:100px">
				<div class="sepet_baslik"><img border="0" src="http://www.metglobaldmc.com//art/mini_lock.png"> Traveller's Info</div>
			</div>
		</div>



		<div class="details col-md-4" style="padding: 0px 0 0 5px;">
			<img src="http://www.metglobaldmc.com/photo_gallery/max/20160627464012.jpg" class="img-responsive">
			<div class="sub-details">
				<div class="profile-usertitle-name" style="font-size: 15px;font-weight: bolder"> MANCHESTER A	
					ENGLISH PREMIER LEAGUE MATCH TICKETS 2016/2017 LIVERPOOL VS BURNLEY 20 AUGUST 2016 </div>
					<div class="profile-usertitle-job"> 
						Service Type: Activities<br>
						<br>
						Service Date: 20.08.2016<br>
			...
			<div class="col-md-8" style="padding: 0px 5px 0 0;">
