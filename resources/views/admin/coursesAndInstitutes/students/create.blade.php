	...
	<div class="col-md-12">
		...
		<div class="portlet light portlet-fit portlet-form ">
			...
			<div class="portlet-body">
				...
				<!-- BEGIN FORM-->
				{{Form::open(array('route' => ['admin.students.store' , $data['id']], 'method'=>'post' , 'files'=>'true' , 'class'=>'form-horizontal'))}}
				<div class="form-body">
						...
						<center>
							...
							<div class="col-md-8">
								...
								<div class="form-group">
									...
									<div class="col-md-8">
										{{Form::text('birth_date' , '' , ["autofocus"=>"autofocus" , "autocomplete" =>"on" , "class"=>"form-control form-control-inline  date-picker" , "placeholder"=>"dd/mm/yyyy"])}}
								...
								<div class="form-group">
									...
									<div class="col-md-8">
										{{Form::text('nationality' , '' , ['class'=>'form-control' , "autofocus"=>"autofocus" , "autocomplete" =>"on" ])}}
								...
								<div class="form-group">
									...
									<div class="col-md-8">
										{{Form::email('email' , '' , ['class'=>'form-control' , "autofocus"=>"autofocus" , "autocomplete" =>"on" ])}}
								...
								<div class="form-group">
									...
									<div class="col-md-8">
										{{Form::text('mobile' , '' , ['class'=>'form-control' , "autofocus"=>"autofocus" , "autocomplete" =>"on" ])}}
