		...
		<div class="portlet light portlet-fit portlet-form ">
			<div class="portlet-title">
				<div class="caption">
					...
					<span class="caption-subject font-green bold uppercase">  اضافة معهد / كلية / جامعة جديدة</span>
				</div>
			</div>
			<div class="portlet-body">
				<!-- BEGIN FORM-->
				{!!Form::open(array('url' => 'admin/institutes','method'=>'post','class'=>'form-horizontal' , 'files' => 'true'))!!}
				<div class="form-body">
					...
					<div class="form-group  margin-top-20">
						...
						<div class="col-md-4">
							<div class="input-icon right">
								<i class="fa"></i>
								{!!Form::select('country_code', $all_country , '',array('placeholder'=>'اختر الدولة ....','class'=>' form-control bs-select' , 'data-live-search' => 'true'  ,'id' => 'country'))!!}
					...
					<div class="form-group">
						...
						<div class="col-md-4">
							<div class="input-icon right">
								<i class="fa"></i>
								{!!Form::text('name','',array('placeholder'=>'اسم المعهد','class'=>'form-control',  "autocomplete" =>"on" ))!!}
					...
					<div class="form-group  margin-top-20">
						...
						<div class="col-md-4">
							<div class="input-icon right">
								<i class="fa"></i>
								{!!Form::text('phone' , '',array('placeholder'=>'00000000', "autofocus"=>"autofocus",'class'=>'form-control'))!!}
					...
					<div class="form-group">
						...
						<div class="col-md-4"> 
							<div class="input-icon right">
								<i class="fa"></i>
								{!!Form::text('mobile' , '',array('placeholder'=>'00966123456789', "autofocus"=>"autofocus",'class'=>'form-control'))!!}
					...
					<div class="form-group">
						...
						<div class="col-md-4"> 
							<div class="input-icon right">
								<i class="fa"></i>
								{!!Form::text('web_site' , '',array('placeholder'=>'http://www.example.com', "autofocus"=>"autofocus",'class'=>'form-control'))!!}
					...
					<div class="form-group">
						...
						<div class="col-md-4"> 
							<div class="input-icon right">
								<i class="fa"></i>
								{!!Form::text('postal_code' , '',array('placeholder'=>'00000', "autofocus"=>"autofocus",'class'=>'form-control'))!!}
					...
					<div class="form-group">
						...
						<div class="col-md-4"> 
							<div class="input-icon right">
								<i class="fa"></i>
								{!!Form::textarea('address' , '',array('placeholder'=>'عنوان المعهد بالتفصيل', "autofocus"=>"autofocus",'class'=>'form-control'))!!}
