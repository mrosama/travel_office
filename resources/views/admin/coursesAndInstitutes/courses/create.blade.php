		...
		<div class="portlet light portlet-fit portlet-form ">
			<div class="portlet-title">
				<div class="caption" style="float:right">
					...
					<span class="caption-subject font-green bold uppercase">اضافه  دورة جديدة</span>
				</div>
			</div>
			...
			<div class="portlet-body">
				...
				<!-- BEGIN FORM-->
				{{Form::open(array('route' => 'admin.courses.store', 'method'=>'post' , 'files'=>'true' , 'class'=>'form-horizontal'))}}
				<div class="form-body">
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							{{Form::text('duration_in_days', '' , ['class'=>'form-control'])}}
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							{{Form::text('duration_in_weeks', '' , ['class'=>'form-control'])}}
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							{{Form::text('duration_in_month', '' , ['class'=>'form-control'])}}
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							{{Form::text('start_date' , '' , ["autofocus"=>"autofocus" , "autocomplete" =>"on" , "class"=>"form-control form-control-inline  date-picker" , "placeholder"=>"dd/mm/yyyy"])}}
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							{{Form::text('end_date' , '' , ["autofocus"=>"autofocus" , "autocomplete" =>"on" , "class"=>"form-control form-control-inline  date-picker" , "placeholder"=>"dd/mm/yyyy"])}}
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							{{Form::select('level',  ["b"=>"مبتدء" , "m"=>"متوسط" , "a"=>"متقدم"] , '' , ['class'=>'form-control' , 'placeholder'=>'من فضلك اختر مستوى الدورة'])}}
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							{{Form::select('language', ["a"=>"عربى" , "e"=>"انجليزى"] , "" , ['class'=>'form-control' , 'placeholder'=>'من فضلك اختر لغة الدورة'])}}
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							{{Form::text('dayly_hours' , '' , ["autofocus"=>"autofocus" , "autocomplete" =>"on" , "class"=>"form-control"])}}
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							{{Form::text('total_hours' , '' , ["autofocus"=>"autofocus" , "autocomplete" =>"on" , "class"=>"form-control"])}}
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							{{Form::text('price' , '' , ["autofocus"=>"autofocus" , "autocomplete" =>"on" , "class"=>"form-control"])}}
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							{{Form::textarea('conditions' , '' , ["autofocus"=>"autofocus" , "autocomplete" =>"on" , "class"=>"form-control"])}}
						...
						<center>
							...
							<div class="col-md-8">
								...
								<div class="form-group">
									...
									<div class="col-md-8">
										{{Form::text('advertisment_date' , '' , ["autofocus"=>"autofocus" , "autocomplete" =>"on" , "class"=>"form-control form-control-inline  date-picker" , "placeholder"=>"dd/mm/yyyy"])}}
								...
								<div class="form-group">
									...
									<div class="col-md-8">
										{{Form::text('advertisment_duration' , '' , ["autofocus"=>"autofocus" , "autocomplete" =>"on" , "class"=>"form-control"])}}
