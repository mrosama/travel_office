        ...
        <div class="portlet light portlet-fit portlet-form ">
            <div class="portlet-title">
                <div class="caption" style="float:right">
                    ...
                    <span class="caption-subject font-green bold uppercase">  تعديل بيانات باص</span>
                </div>
            ...
            <div class="portlet-body">
                ...
                <!-- BEGIN FORM-->
                {{Form::open(array('route' => ['admin.busses.update' , $bus->id], 'method'=>'put' , 'files'=>'true' , 'class'=>'form-horizontal' ,"novalidate"=>"novalidate" , "id"=>"form"))}}
                <div class="form-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-7">
                            {{Form::select('branch_id' , $bussesBranches , $bus->branch->id , ["autofocus"=>"autofocus" , "id" => "branch_id" , "autocompletebranch_id" =>"on" , "class"=>"bs-select form-control" , "data-live-search"=>"true" , 'placeholder'=>'من فضلك اختر الفرع' , 'required'])}}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-7">
                            {{Form::select('supplier_id' , $busses_suppliers , $bus->supplier->id , ['class'=>'form-control' , "autofocus"=>"autofocus" , "autocomplete" =>"on" , 'placeholder'=>'من فضلك اختر مزود الباص' , 'required'])}}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            {{Form::text('number' , $bus->number , ['class'=>'form-control' , "autofocus"=>"autofocus" , "autocomplete" =>"on" , 'required' , 'number'])}}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            {{Form::text('model' , $bus->model , ['class'=>'form-control' , "autocomplete" =>"on" , 'required'])}}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            {{Form::text('color' , $bus->color , ['class'=>'form-control' , "autocomplete" =>"on" , 'required'])}}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            {{Form::select('size' , ['كبير 50 مقعد'=>'كبير 50 مقعد' ,'وسط 25 مقعد'=>'وسط 25 مقعد' , 'صغير 12 مقعد'=>'صغير 12 مقعد'] , $bus->size , ['class'=>'form-control' , "autocomplete" =>"on" , 'placeholder'=>'من فضلك اختر حجم الباص' , 'required'])}}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            {{Form::text('license_number' , $bus->license_number , ['class'=>'form-control' , "autocomplete" =>"on" , 'required'])}}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            {{Form::text('run_card_number' , $bus->run_card_number , ['class'=>'form-control' , "autocomplete" =>"on"  , 'required'])}}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            {{Form::text('hajj_permit' , $bus->hajj_permit , ['class'=>'form-control' , "autocomplete" =>"on"  , 'required'])}}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            {{Form::text('permit_number' , $bus->permit_number , ['class'=>'form-control' , "autocomplete" =>"on"  , 'required'])}}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            {{Form::text('permit_duration' , $bus->permit_duration , ['class'=>'form-control' , "autocomplete" =>"on"  , 'required'])}}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            {{Form::date('permit_date' , $bus->permit_date , ['class'=>'form-control' , "autocomplete" =>"on" , 'required' ])}}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            {{Form::date('permit_end_date' , $bus->permit_end_date , ['class'=>'form-control' , "autocomplete" =>"on"  , 'required'])}}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            {{Form::textarea('notes' , $bus->notes , ['class'=>'form-control' , 'required'])}}
