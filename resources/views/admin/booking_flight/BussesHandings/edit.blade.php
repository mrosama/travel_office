        ...
        <div class="portlet light portlet-fit portlet-form ">
            <div class="portlet-title">
                <div class="caption" style="float:right">
                    <span class="caption-subject font-green bold uppercase">  الرحلات السياحية</span> | <span class="caption-subject font-green  uppercase">  تعديل بيانات تسليم باص لسائق</span>
                </div>
                <a href="{{URL::to('/admin/busses/Handings')}}" class="btn btn-success pull-right">عرض الكل</a>
            </div>
            <div class="portlet-body">
                <!-- BEGIN FORM-->
                {{Form::open(array('route' => ['admin.busses.Handings.update' , $bussesHanding->id], 'method'=>'put' , 'files'=>'true' , 'class'=>'form-horizontal' , "novalidate"=>"novalidate" , "id"=>"form"))}}
                <div class="form-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            {{Form::select('driverID' , $drivers , $bussesHanding->driverID , [ "class"=>"bs-select form-control" , 'id' => 'driverID' , "data-live-search"=>"true" , "autocomplete" =>"on" , 'placeholder'=>'من فضلك اختر اسم السائق' , 'required'])}}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            {{Form::select('busID' , $busses , $bussesHanding->busID , [ "class"=>"bs-select form-control" , 'id' => 'busID' , "data-live-search"=>"true" , "autocomplete" =>"on" , 'placeholder'=>'من فضلك اختر  الباص' , 'required'])}}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            {{Form::select('benzeneCoupon' , ['نعم' => 'نعم' , 'لا' => 'لا'] , $bussesHanding->benzeneCoupon , [ "class"=>"bs-select form-control" , "autocomplete" =>"on" , 'placeholder'=>'هل تم استلام كوبون بنزين' , 'required'])}}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            {{Form::number('amountCoupon' , $bussesHanding->amountCoupon , ['class'=>'form-control' , 'required'])}}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            {{Form::text('kiloMeter' , $bussesHanding->kiloMeter , ['class'=>'form-control' , 'required'])}}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            {{Form::textarea('notes' , $bussesHanding->notes , ['class'=>'form-control' , 'required'])}}
