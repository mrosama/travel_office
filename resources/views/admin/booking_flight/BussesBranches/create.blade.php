    ...
    <div class="col-md-12">
        ...
        <div class="portlet light portlet-fit portlet-form ">
            ...
            <div class="portlet-body">
                <!-- BEGIN FORM-->
                {{Form::open(array('route' => 'admin.busses.branches.store', 'method'=>'post' , 'files'=>'true' , 'class'=>'form-horizontal' , "novalidate"=>"novalidate" , "id"=>"form"))}}
                <div class="form-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            {{Form::select('country' , $countries , '' , [ "class"=>"bs-select form-control", "id" => "countryBranch" , "data-live-search"=>"true" , "autocomplete" =>"on" , 'placeholder'=>'اختر الدولة ' , 'required'])}}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            {{Form::text('mangerName' , '' , ['class'=>'form-control' , 'required'])}}
