    ...
    <div class="col-md-12">
        ...
        <div class="portlet light portlet-fit portlet-form ">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-green bold uppercase"> 
                        ارسال بريد الكتروني لمجموعة من المزودين
                    </span>
                </div>
            ...
            <div class="portlet-body">
                <!-- BEGIN FORM-->
                {!!Form::open(array('route' => 'suppliers.send.emails','method'=>'post','class'=>'form-horizontal'))!!}
                <div class="form-body">
                    ...
                    <div class="form-group" id="choose">
                        ...
                        <div class="col-md-8">
                            {{Form::select('emails[]' , $suppliers , '' , ['class'=>'form-control select2-multiple' , 'id'=>'multiple' , 'multiple'])}}
                            <font color="red">{{$errors->first('emails')}}</font>    
                        </div>
                    </div>
