		...
		<div class="portlet light portlet-fit portlet-form ">
			<div class="portlet-title">
				<div class="caption">
					...
					<span class="caption-subject font-green bold uppercase">  اضافه قسم للمؤسسة / الشركة</span>
				</div>

			</div>
			<div class="portlet-body">
				<!-- BEGIN FORM-->
				{!!Form::open(array('url' => 'admin/companySection','method'=>'post','class'=>'form-horizontal'))!!}
				<div class="form-body">
					...
					<div class="form-group">
						...
						<div class="col-md-4">
							<div class="input-icon right">
								<i class="fa"></i>
								{!!Form::select('companyId', $all_company , '',array('placeholder'=>'اسم المؤسسة / الشركة','class'=>'bs-select form-control', 'data-live-search' => 'true' , "autofoucs" => "autofoucs"))!!}
