    ...
    <div class="col-md-12">
        ...
        <div class="portlet box green">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-globe"></i>عرض جميع انواع  الرحلات</div>
                <div class="tools"> </div>
            </div>
                ...
                <table class="table table-striped table-bordered table-hover" id="sample_2">
                    ...
                    <tbody>
                        ...
                        <tr class="text-center">
                            ...
                            <td>
                                <a href="{{URL::to('/admin/trips' , [$row->id , 'edit'])}}"><i class="fa fa-edit"></i></a>
                            </td>
                            <td>
                                {{Form::open(['route'=>['admin.trips.destroy' , $row->id] , 'method'=>'delete' , 'id'=>'form'])}}
