...
<div class="page-bar">
	<ul class="page-breadcrumb">
		<li>
			<i class="icon-home"></i>
			<a href="{{URL::to('/')}}/admin/companyOrder">طلبات موظفين المؤسسات والشركات</a>
		</li>
	</ul>
</div>
<div class="row">
	<div class="col-md-12">
		...
		<div class="portlet box green">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-globe"></i>عرض جميع طلبات موظفين المؤسسات والشركات </div>
					<div class="tools"> </div>
				</div>
				<div class="portlet-body">
					<table class="table table-striped table-bordered table-hover" id="sample_2">
						...
						<tbody>
							@foreach($all_companyOrder as $row)
							<tr class="odd gradeX">
								<td>{{$row->id}}</td>
								...
								<td style="display:flex">
									{{Link_to_route('admin.companyOrder.edit' , 'تعديل ' , $row->id)}}
									&nbsp; |&nbsp; 
									{{Form::open(['route'=>['admin.companyOrder.destroy' , $row->id] , 'method'=>'delete' , 'id'=>'form'])}}
									...
									<div class="modal-body"> 
										<?php
										 ...
										 for ($i=0; $i < count($data) ; $i++) { 
											$empId = $data[$i];
											$result = DB::table('company_employees')->where('id', $empId)->select('empName')->first();
