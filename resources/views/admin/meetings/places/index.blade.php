    ...
    <div class="col-md-12">
        ...
        <div class="portlet box green">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-globe"></i>عرض جميع اماكن الاجتماعات </div>
                <div class="tools"> </div>
            </div>
            <div class="portlet-body">
                <div class="table-toolbar">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="btn-group">
                                <a href="{{URL::to('/admin/meeting_places/create')}}" class="btn sbold green"> اضافة مكان جديد
                ...
                <table class="table table-striped table-bordered table-hover" id="sample_2">
                    ...
                    <tbody>
                        ...
                        <tr class="text-center">
                            ...
                            <td>{{$row->place}}</td>			
                            <td>
                                <a href="{{URL::to('/admin/meeting_places' , [$row->id , 'edit'])}}"><i class="fa fa-edit"></i></a>
                            </td>
                            <td>
                                {{Form::open(['route'=>['admin.meeting_places.destroy' , $row->id] , 'method'=>'delete' , 'id'=>'form'])}}
