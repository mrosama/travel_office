    ...
    <div class="col-md-12">
        ...
        <div class="portlet light portlet-fit portlet-form ">
            ...
            <div class="portlet-body">
                ...
                <!-- BEGIN FORM-->
                {{Form::open(array('route' => 'admin.meetings.store', 'method'=>'post' , 'files'=>'true' , 'class'=>'form-horizontal' , "novalidate"=>"novalidate" , "id"=>"form"))}}
                <div class="form-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            {{Form::text('address' , '' , ['class'=>'form-control' , "autofocus"=>"autofocus" , "autocomplete" =>"on"  , 'required'])}}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <div class="input-group date form_meridian_datetime" data-date="2012-12-21T15:25:00Z">
                                {{Form::text('date' , '' , ['class'=>'form-control' , "autocomplete" =>"on" , 'size'=>16 , 'required'])}}
                            ...
                            <font color="red">{{$errors->first('date')}}</font><br>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-3">مكان الاجتماع</label>
                        <div class="col-md-8">
                            {{Form::select('meet_place_id' , $data['places'] , '' , ['class'=>'form-control' , "autofocus"=>"autofocus" , "autocomplete" =>"on" , "class"=>"bs-select form-control" , "data-live-search"=>"true" , 'placeholder'=>'من فضلك اختر المكان'])}}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            {{Form::select('meet_type_id' , $data['types'] , '' , ['class'=>'form-control' , "autofocus"=>"autofocus" , "autocomplete" =>"on" , "class"=>"bs-select form-control" , "data-live-search"=>"true" , 'placeholder'=>'من فضلك اختر النوع'])}}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            {{Form::textarea('brief' , '' , ['class'=>'form-control', 'required'])}}
                    ...
                    <fieldset>
                        ...
                        <div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    {{Form::select('employee_id[]' , [] , '' , ['class'=>'form-control select2-multiple' , 'id'=>'multiple' , 'multiple' , "autofocus"=>"autofocus" , "autocomplete" =>"on" , "data-live-search"=>"true" , 'required'])}}
