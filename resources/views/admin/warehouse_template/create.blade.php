        ...
        <div class="portlet light portlet-fit portlet-form ">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-green bold uppercase">  اضافه نموذج جديد</span>
                </div>
                <a href="{{URL::to('admin/warehouse_template')}}" class="btn btn-danger" style="float: left"> عرض جميع النماذج </a>
            </div>
            <div class="portlet-body">
                <!-- BEGIN FORM-->
                {!!Form::open(array('url' => 'admin/warehouse_template','method'=>'post', 'files' => true ,'class'=>'form-horizontal'))!!}
                <div class="form-body">
                    ...
                    <div class="form-group  margin-top-20">
                        ...
                        <div class="col-md-7">
                            <div class="input-icon right">
                                <i class="fa"></i>
                                {!!Form::text('title','',array('placeholder'=>'عنوان النموذج','class'=>'form-control',"autocomplete" =>"on"  , "autofocus"=>"autofocus"))!!}
                    ...
                    <div class="form-group  margin-top-20">
                        ...
                        <div class="col-md-7">
                            <div class="input-icon right">
                                <i class="fa"></i>
                                {!!Form::select('type', [ 'public' => 'عام' , 'private' => 'خاص'] ,'' ,array('placeholder'=>'نوع النموذج','class'=>'form-control',"autocomplete" =>"on"))!!}
