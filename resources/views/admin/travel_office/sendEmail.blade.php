        ...
        <div class="portlet light portlet-fit portlet-form ">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-green bold uppercase"> ارسال بريد الكتروني للمكتب السياحي والديني </span>
                </div>

            </div>
            <div class="portlet-body">
                <!-- BEGIN FORM-->
                {!!Form::open(array('url' => 'admin/travel_offices/doSendEmail/'.$office->id ,'method'=>'post','class'=>'form-horizontal'))!!}
                <div class="form-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <div class="input-icon right">
                                {!!Form::text('msg_title','',array('placeholder'=>'عنوان الرسالة','class'=>'form-control', "autofoucs" => "autofoucs" , "autocomplete" =>"on" ))!!}
                                {!! $errors->first('msg_title','<div class="alert alert-danger">:message</div>')!!}                                 
                            </div>
                        </div>
                    </div>
