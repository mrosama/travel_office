        ...
        <div class="portlet light portlet-fit portlet-form ">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-green bold uppercase">  اضافه مكتب سياحي / ديني جديد</span>
                </div>

            </div>
            <div class="portlet-body">
                <!-- BEGIN FORM-->
                {!!Form::open(array('url' => 'admin/travel_offices','method'=>'post','class'=>'form-horizontal'  , 'files' =>true))!!}
                <div class="form-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-7">
                            <div class="input-icon right">
                                <i class="fa"></i>
                                {!!Form::text('name','',array('placeholder'=>'اسم المكتب','class'=>'form-control', "autofoucs" => "autofoucs" , "autocomplete" =>"on" ))!!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-7">
                            <div class="input-icon right">
                                <i class="fa"></i>
                                {!!Form::text('work_time','',array('placeholder'=>'اوقات الدوام','class'=>'form-control' , "autocomplete" =>"on" ))!!}
                                {!! $errors->first('work_time','<div class="alert alert-danger">:message</div>')!!}                            
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-3">اسم صاحب المكتب
                            <span class="required"> * </span>
                        </label>
                        <div class="col-md-7">
                            <div class="input-icon right">
                                <i class="fa"></i>
                                {!!Form::text('owner_name','',array('placeholder'=>'اسم صاحب المكتب','class'=>'form-control' , "autocomplete" =>"on" ))!!}
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-3">لوغو المكتب
                            <span class="required"> * </span>
                        </label>
                        <div class="col-md-4">
                            <div class="input-icon right">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            {!!Form::text('lat','',array('placeholder'=>'lat','class'=>'form-control', "id" => "lat" ))!!}
                            {!! $errors->first('lat','<div class="alert alert-danger">:message</div>')!!}                            

                        </div>
                        <div class="col-md-4">
                            {!!Form::text('lang','',array('placeholder'=>'lang','class'=>'form-control', "id" => "lang" ))!!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-7">
                            {{Form::text('user_name' , '' , ['class' => 'form-control' ,"autocomplete" =>"on" ])}}
