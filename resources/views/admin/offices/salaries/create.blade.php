		...
		<div class="portlet light portlet-fit portlet-form ">
			<div class="portlet-title">
				<div class="caption">
					...
					<span class="caption-subject font-green bold uppercase">  اضافه  راتب جديد</span>
				</div>

			</div>
			<div class="portlet-body">
				<!-- BEGIN FORM-->
				{!!Form::open(array('route' => 'admin.salaries.store','method'=>'post','class'=>'form-horizontal' , "novalidate"=>"novalidate" , "id"=>"form"))!!}
				<div class="form-body">
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							{{Form::select('employee_id', $employees , '' ,array('placeholder'=>'من فضلك اختر الموظف',
					...
					<div class="form-group">
						...
						<div class="col-md-2">
							{!!Form::number('basic_salary','',array('placeholder'=>'الراتب الاساسى',
						...
						<div class="col-md-2">
							{!!Form::number('transportation_allowance','',array('placeholder'=>'بدل مواصلات',
						...
						<div class="col-md-2">
							{!!Form::number('house_allowance','',array('placeholder'=>'بدل سكن',
							'class'=>'form-control',"autocomplete" =>"on"   , "autofocus"=>"autofocus"  , 'number'))!!}
					...
					<div class="form-group">
						...
						<div class="col-md-2">
							{!!Form::number('number_extra_hours','',array('placeholder'=>'عدد الساعات الاضافية',
							'class'=>'form-control',"autocomplete" =>"on"   , "autofocus"=>"autofocus"  , 'number'))!!}
						...
						<div class="col-md-2">
							{!!Form::number('number_extra_days','',array('placeholder'=>'عدد الايام الاضافية',
							'class'=>'form-control',"autocomplete" =>"on"   , "autofocus"=>"autofocus"  , 'number'))!!}
						...
						<div class="col-md-2">
							{!!Form::number('holiday_allowance','',array('placeholder'=>'بدل عيد','class'=>'form-control',  "autocomplete" =>"on" , 'number'))!!}
					...
					<div class="form-group">
						...
						<div class="col-md-3">
							{!!Form::number('other_allowances','',array('placeholder'=>'بدلات اخرى','class'=>'form-control',  "autocomplete" =>"on" , 'number'))!!}
						...
						<div class="col-md-3">
							{!!Form::number('amount_deducted','',array('placeholder'=>'المبلغ المخصوم','class'=>'form-control',  "autocomplete" =>"on" , 'number'))!!}
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							{!!Form::textarea('discount_reason','',array('placeholder'=>'ملاحظات','class'=>'form-control',  "autocomplete" =>"on" ))!!}
