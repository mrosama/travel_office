...
<div class="page-bar">
	<ul class="page-breadcrumb">
		<li>
			<i class="icon-home"></i>
			<a href="{{URL::to('/')}}/admin/companyEmployee">موظفين المكاتب السياحية / الدينية</a>
		</li>
	</ul>
</div>
<div class="row">
	<div class="col-md-12">
		...
		<div class="portlet box green">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-globe"></i>عرض جميع موظفين المكاتب السياحية / الدينية </div>
					<div class="tools"> </div>
				</div>
						...
						<tbody>
							...
							<tr class="odd gradeX">
								...
								<td style="display:flex">
									{{Link_to_route('admin.travel_employees.edit' , 'تعديل ' , $row->id)}}
									&nbsp; |&nbsp; 
									{{Form::open(['route'=>['admin.travel_employees.destroy' , $row->id] , 'method'=>'delete' , 'id'=>'form'])}}
