		...
		<div class="portlet light portlet-fit portlet-form ">
			<div class="portlet-title">
				<div class="caption">
					...
					<span class="caption-subject font-green bold uppercase">  اضافه موظف للمكت السياحي / الديني</span>
				</div>

			</div>
			<div class="portlet-body">
				<!-- BEGIN FORM-->
				{!!Form::open(array('url' => 'admin/travel_employees','method'=>'post','class'=>'form-horizontal' , 'files' => true))!!}
				<div class="form-body">
					...
					<div class="form-group">
						...
						<div class="col-md-4">
							<div class="input-icon right">
								<i class="fa"></i>
								{!!Form::select('travel_officeId', $all_office , '',array('placeholder'=>'اسم المكتب','class'=>'bs-select form-control', "autofoucs" => "autofoucs" , 'data-live-search' => 'true' , 'id' => 'travel_officeId' , 'onchange' =>'getTravelSection()'))!!}
					...
					<div class="form-group">
						...
						<div class="col-md-4">
							<select name="sectionId" id="sectionId" class=" bs-select form-control" data-live-search = 'true'>
								<option selected="" disabled="" value="">اختر اسم المكتب اولا ...</option>
							</select>
