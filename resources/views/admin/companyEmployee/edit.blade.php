	...
	<div class="col-md-12">
		...
		<div class="portlet light portlet-fit portlet-form ">
			...
			<div class="portlet-body">
				<!-- BEGIN FORM-->
				{!!Form::open(['route' =>['admin.companyEmployee.update' , $employee->id],'method'=>'put','class'=>'form-horizontal' , 'files' => true])!!}
				<div class="form-body">
					...
					<div class="form-group">
						...
						<div class="col-md-4">
							<select name="companyId" class="form-control bs-select" data-live-search= 'true' id="companyId" onchange="getSection()">
								<option value="{{$employee->companyId}}">{{$employee->companyName->name}}</option>
