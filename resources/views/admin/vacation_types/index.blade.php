    ...
    <div class="col-md-12">
        ...
        <div class="portlet box green">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-globe"></i>عرض جميع انواع  الاجازات</div>
                <div class="tools"> </div>
            </div>
            <div class="portlet-body">
                <table class="table table-striped table-bordered table-hover" id="sample_2">
                    ...
                    <tbody>
                        <?php $i=0;?>
                        @foreach($vacation_types as $row)
                        <tr class="text-center">
                            <td>{{++$i}}</td>
                            <td>{{$row->name}}</td>
                            <td>{{$row->created_at}}</td>
                            <td>
                                <a href="{{URL::to('/admin/vacation_types' , [$row->id , 'edit'])}}"><i class="fa fa-edit"></i></a>
                            </td>
                            <td>
                                {{Form::open(['route'=>['admin.vacation_types.destroy' , $row->id] , 'method'=>'delete' , 'id'=>'form'])}}
