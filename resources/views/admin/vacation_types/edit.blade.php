...
<div class="page-bar">
    <ul class="page-breadcrumb">
        <li>
            <i class="icon-home"></i>
            <a href="{{URL::to('/')}}/admin/vacation_types ">انواع  الاجازات</a>
        </li>
        <i class="fa fa-angle-left"></i>
        <li>تعديل نوع الاجازة  </li>
    </ul>
</div>
        ...
        <div class="portlet light portlet-fit portlet-form ">
            <div class="portlet-title">
                <div class="caption" style="float:right">
                    ...
                    <span class="caption-subject font-green bold uppercase"> تعديل نوع الاجازة </span>
                </div>
            </div>
            ...
            <div class="portlet-body">
                ...
                <!-- BEGIN FORM-->
                {{Form::open(array('route' => ['admin.vacation_types.update' , $vacation_type->id], 'method'=>'patch'  , 'class'=>'form-horizontal' , "novalidate"=>"novalidate" , "id"=>"form"))}}
                <div class="form-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-7">
                            {{Form::text('name' , $vacation_type->name , ['class' => 'form-control' , "autofocus"=>"autofocus" ,"autocomplete" =>"on" , 'required'])}}
                        </div>
                    </div>
