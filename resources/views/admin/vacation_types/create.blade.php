        ...
        <div class="portlet light portlet-fit portlet-form ">
            <div class="portlet-title">
                <div class="caption" style="float:right">
                    ...
                    <span class="caption-subject font-green bold uppercase">اضافة نوع اجازة</span>
                </div>
            </div>
            ...
            <div class="portlet-body">
                ...
                <!-- BEGIN FORM-->
                {{Form::open(array('route' => 'admin.vacation_types.store', 'method'=>'post'  , 'class'=>'form-horizontal' , "novalidate"=>"novalidate" , "id"=>"form"))}}
                <div class="form-body">
