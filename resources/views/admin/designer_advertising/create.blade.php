        ...
        <div class="portlet light portlet-fit portlet-form ">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-green bold uppercase">  اضافه مصمم جديد</span>
                </div>
                <a href="{{URL::to('admin/designer_advertising')}}" class="btn btn-danger" style="float: left"> عرض جميع المصممين </a>
            </div>
            <div class="portlet-body">
                <!-- BEGIN FORM-->
                {!!Form::open(array('url' => 'admin/designer_advertising','method'=>'post','class'=>'form-horizontal' , 'files' => 'true'))!!}
                <div class="form-body">
                    ...
                    <div class="form-group  margin-top-20">
                        ...
                        <div class="col-md-7">
                            <div class="input-icon right">
                                <i class="fa"></i>
                                {!!Form::text('name','',array('placeholder'=>'الاسم', 'class'=>'form-control',"autocomplete" =>"on"  , "autofocus"=>"autofocus"))!!}
                    ...
                    <div class="form-group  margin-top-20">
                        ...
                        <div class="col-md-7">
                            <div class="input-icon right">
                                <i class="fa"></i>
                                {!!Form::text('facebook','',array('placeholder'=>'فيس بوك', 'class'=>'form-control',"autocomplete" =>"on"))!!}
                    ...
                    <div class="form-group  margin-top-20">
                        ...
                        <div class="col-md-7">
                            <div class="input-icon right">
                                <i class="fa"></i>
                                {!!Form::text('twitter','',array('placeholder'=>'تويتر', 'class'=>'form-control',"autocomplete" =>"on"))!!}
                    ...
                    <div class="form-group  margin-top-20">
                        ...
                        <div class="col-md-7">
                            <div class="input-icon right">
                                <i class="fa"></i>
                                {!!Form::text('instagram','',array('placeholder'=>'انستغرام', 'class'=>'form-control',"autocomplete" =>"on"))!!}
                    ...
                    <div class="form-group  margin-top-20">
                        ...
                        <div class="col-md-7">
                            <div class="input-icon right">
                                <i class="fa"></i>
                                {!!Form::text('skype','',array('placeholder'=>'سكايب', 'class'=>'form-control',"autocomplete" =>"on"))!!}
