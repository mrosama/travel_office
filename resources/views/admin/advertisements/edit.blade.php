        ...
        <div class="portlet light portlet-fit portlet-form ">
            <div class="portlet-title">
                <div class="caption" style="float:right">
                    ...
                    <span class="caption-subject font-green bold uppercase">تعديل اعلان</span>
                </div>
            ...
            <div class="portlet-body">
                ...
                <!-- BEGIN FORM-->
                {{Form::open(array('route' => ['admin.advertisements.update' , $advertisement->id], 'method'=>'put' , 'files'=>'true' , 'class'=>'form-horizontal' , "novalidate"=>"novalidate" , "id"=>"form"))}}
                <div class="form-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-7">
                            {{Form::select('designer_id' , $designers , $advertisement->designer_id , ["autocomplete" =>"on" , 'placeholder'=>'من فضلك قم باختيار المصمم' , "class"=>"bs-select form-control" , "data-live-search"=>"true" , 'required'])}}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            {{Form::text('title' ,$advertisement->title, ['class'=>'form-control' , "autocomplete" =>"on" , 'required'])}}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            {{Form::text('mobile' ,$advertisement->mobile, ['class'=>'form-control' , "autocomplete" =>"on" , 'required' , 'number'])}}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            {{Form::text('phone' ,$advertisement->phone, ['class'=>'form-control' , "autocomplete" =>"on" , 'required' , 'number'])}}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            {{Form::email('email' ,$advertisement->email, ['class'=>'form-control' , "autocomplete" =>"on" , 'required' , 'email'])}}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            {{Form::date('start' ,$advertisement->start, ['class'=>'form-control' , "autocomplete" =>"on" , 'required' , 'date'])}}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            {{Form::date('end' ,$advertisement->end, ['class'=>'form-control' , "autocomplete" =>"on" , 'required' , 'date'])}}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            {{Form::text('duration' ,$advertisement->duration, ['class'=>'form-control' , "autocomplete" =>"on" , 'required'])}}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            {{Form::select('country' , $countries , $advertisement->country , ["autocomplete" =>"on" , 'placeholder'=>'من فضلك قم باختيار الدولة' , "class"=>"bs-select form-control" , "data-live-search"=>"true"])}}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            {{Form::select('city' , $cities , $advertisement->city , ["class"=>"bs-select form-control" , "data-live-search"=>"true"  , "data-live-search"=>"true"])}}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            ...
                            <p>
                                ...
                                لرؤية الملف المرفوع من قبل <a href="{{URL::to($advertisement->file)}}"> اضغط هنا</a>
                                @else
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            {{Form::textarea('notes' ,$advertisement->notes, ['class'=>'form-control' , "autocomplete" =>"on" , 'required'])}}
