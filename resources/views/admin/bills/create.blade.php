	...
	<div class="col-md-12">
		...
		<div class="portlet light portlet-fit portlet-form ">
			...
			<div class="portlet-body">
				<!-- BEGIN FORM-->
				{!!Form::open(array('url' => 'admin/bills','method'=>'post','class'=>'form-horizontal' , 'files' => 'true'))!!}
				<div class="form-body">
					...
					<div class="form-group  margin-top-20">
						...
						<div class="col-md-4">
							<div class="input-icon right">
								<i class="fa"></i>
								{!!Form::select('client_id', $all_client , '',array('placeholder'=>'اسم العميل', "autofocus"=>"autofocus",'class'=>'form-control' , 'id' => "client_id", 'onchange' => 'getClientInfo()'))!!}
					...
					<div class="form-group">
						...
						<div class="col-md-4">
							<div class="input-icon right">
								<i class="fa"></i>
								{!!Form::text('receipt','',array('placeholder'=>'رقم سند القبض','class'=>'form-control',  "autocomplete" =>"on" ))!!}
					...
					<div class="form-group">
						...
						<div class="col-md-4">
							{!!Form::select('country', $all_country , '',array('placeholder'=>'اختر الدولة ....','class'=>' form-control bs-select' , 'data-live-search' => 'true'  ,'id' => 'country'))!!}
					...
					<div class="form-group">
						...
						<div class="col-md-4">
							<select name="city" id="city" class="form-control bs-select" data-live-search="true">
								<option selected="" disabled="">اختر الدولة اولا ...</option>
							</select>
					...
					<div class="form-group">
						...
						<div class="col-md-4">
							<div class="input-icon right">
								<i class="fa"></i>
								{!!Form::text('flight_type','',array('placeholder'=>'نوع الطيران','class'=>'form-control',  "autocomplete" =>"on" ))!!}
					...
					<div class="form-group">
						...
						<div class="col-md-4">
							<div class="input-icon right">
								<i class="fa"></i>
								{!!Form::text('traveles','',array('placeholder'=>'عدد المسافرون','class'=>'form-control',  "autocomplete" =>"on" ))!!}
					...
					<div class="form-group">
						...
						<div class="col-md-4">
							<div class="input-icon right">
								<i class="fa"></i>
								<input class="form-control form-control-inline date-picker"  name="date_go" placeholder="dd/mm/yyyy" data-date-format="dd/mm/yyyy" size="16" type="text">
					...
					<div class="form-group">
						...
						<div class="col-md-4">
							<div class="input-icon right">
								<i class="fa"></i>
								<input class="form-control form-control-inline date-picker"  name="date_back" placeholder="dd/mm/yyyy" data-date-format="dd/mm/yyyy" size="16" type="text">
					...
					<div class="form-group">
						...
						<div class="col-md-4">
							<div class="input-icon right">
								<i class="fa"></i>
								{!!Form::text('dayNights','',array('placeholder'=>'عدد الليالي','class'=>'form-control',  "autocomplete" =>"on" ))!!}
					...
					<div class="form-group">
						...
						<div class="col-md-3">
							<div class="input-icon right">
								<i class="fa"></i>
								{!!Form::text('price_sa','',array('placeholder'=>'ريال سعودي','class'=>'form-control', 'id' =>'price_sa'  ,  "autocomplete" =>"on" ))!!}
						...
						<div class="col-md-3">
							<div class="input-icon right">
								<i class="fa"></i>
								{!!Form::text('price_ba','',array('placeholder'=>'دينار بحريني','class'=>'form-control', 'id' =>'price_ba' ,  "autocomplete" =>"on" ))!!}
						...
						<div class="col-md-3">
							<div class="input-icon right">
								<i class="fa"></i>
								{!!Form::text('price_us','',array('placeholder'=>'دولار امريكي','class'=>'form-control', 'id' => 'price_us' ,  "autocomplete" =>"on" ))!!}
